...
import cn.zkz.common.core.GlobalApplicationContext;
import cn.zkz.common.redis.lock.annotation.RedisLock;
import cn.zkz.common.redis.lock.exception.RedisLockInvocationException;
...
public class RedisLockAspectHandler {
    ...
    public Object around(ProceedingJoinPoint joinPoint, RedisLock redisLock) throws Throwable {
        LockInfo lockInfo = GlobalApplicationContext.getBean(LockInfoProvider.class).get(joinPoint, redisLock);
        String curentLock = this.getCurrentLockId(joinPoint, redisLock);
    ...
    public void afterReturning(JoinPoint joinPoint, RedisLock redisLock) throws Throwable {
        String curentLock = this.getCurrentLockId(joinPoint, redisLock);
        releaseLock(redisLock, joinPoint, curentLock);
     ...
     * 释放锁
     */
    private void releaseLock(RedisLock redisLock, JoinPoint joinPoint, String curentLock) throws Throwable {
     ...
     * @return
     */
    private String getCurrentLockId(JoinPoint joinPoint, RedisLock redisLock) {
        LockInfo lockInfo = GlobalApplicationContext.getBean(LockInfoProvider.class).get(joinPoint, redisLock);
